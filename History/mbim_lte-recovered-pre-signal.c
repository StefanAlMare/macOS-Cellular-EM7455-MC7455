...
int main(void)
{
     ...
     */
    {
        ...
        /*
         * Dacă� ră�spunsul a fost ACTIVATING, interogă�m Session 0
         * pÃ�nă� devine ACTIVATED.
         */
        if (!bearer_activated && activation_state == 2) {
            ...
            for (int attempt = 0; attempt < 15 && !bearer_activated; attempt++) {
                ...
                /* Restul query-ului ră�mÃ�ne zero; SessionId=0 */
